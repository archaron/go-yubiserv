...
build:
	...
	GOOS=linux CGO_ENABLED=0  go build -ldflags="-s -w -X ${PACKAGE}/misc.Version=${VERSION} -X ${PACKAGE}/misc.Build=${BUILD}" -o ./bin/yubiserv ./cmd/go-yubiserv && upx -9 ./bin/yubiserv
